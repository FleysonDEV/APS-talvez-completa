...
public class SeraVerdadePrincipal extends JFrame implements Exibivel {
    ...
    public void configurarLayout() {
        ...
        btIniciar.addActionListener(e -> {
            ...
            ArrayList<String> corretas3 = new ArrayList<>();
            corretas3.add("Fontes Não Científicas");
            corretas3.add("Linguagem Tendenciosa");
            corretas3.add("Teoria da Conspiração");

            bancoManchetes.add(new QuestaoQuiz(false, "noticia 3.jpg", just3, corretas3, "Este texto é falso porque nega fatos históricos e científicos amplamente comprovados. A afirmação de que não há evidências de que a vacinação erradicou a varíola e a poliomielite é mentirosa, visto que a varíola foi declarada erradicada pela OMS em 1980 exclusivamente devido à vacinação global. O texto utiliza uma linguagem alarmista e ideológica para deslegitimar décadas de dados epidemiológicos que mostram a queda drástica de casos imediatamente após o início das campanhas de imunização. Ao tratar sucessos médicos indiscutíveis como \"mitos\", o conteúdo manipula a opinião pública e ignora o consenso científico que garante a segurança e eficácia dessas vacinas."));
            ...
            ArrayList<String> corretas7 = new ArrayList<>();
            corretas7.add("Uso de Imagem Manipuladora");
            corretas7.add("Apelo ao Medo");
            corretas7.add("Linguagem Tendenciosa");

            bancoManchetes.add(new QuestaoQuiz(false, "noticia 7.jpg", just7, corretas7, "A alegação de que as vacinas de RNA mensageiro alteram o DNA é biologicamente impossível. O DNA humano fica protegido dentro do núcleo da célula, enquanto o RNA da vacina atua apenas no citoplasma, sem nunca entrar no núcleo ou ter contato com o nosso código genético.\n\n" +
            ...
            ArrayList<String> corretas9 = new ArrayList<>();
            corretas9.add("Apelo ao medo");
            ...
            ArrayList<String> corretas10 = new ArrayList<>();
            corretas10.add("Apelo ao medo");
            corretas10.add("Descontextualização Profissional");
            corretas10.add("Teoria da Conspiração ");

            bancoManchetes.add(new QuestaoQuiz(false, "noticia 10.jpg", just10, corretas10, "O post usa o Hospital Edogawa como cenário para dar credibilidade a uma história inventada. As máquinas mostradas são para tratar cânceres convencionais com tecnologia de ponta, e não para reverter efeitos de vacinas. O termo \"turbo câncer\" é uma ferramenta de marketing do medo, sem qualquer código correspondente no CID (Classificação Internacional de Doenças).\n"));
            ...
            ArrayList<String> corretas11 = new ArrayList<>();
            corretas11.add("Contexto Histórico");
            corretas11.add("Ausência de Sensacionalismo");
            corretas11.add("Transparência de Metodologia ");

            bancoManchetes.add(new QuestaoQuiz(true, "noticia 11.jpg", just11, corretas11, "A notícia do portal Metrópoles é verdadeira, baseada em um estudo da revista Pediatrics de fevereiro de 2026. A pesquisa confirma que a quantidade de alumínio nas vacinas acumulada até os 18 anos é mínima, segura e não causa autismo ou doenças neurológicas. O mineral atua como um adjuvante para fortalecer a imunidade, sendo que a exposição diária via alimentos e leite materno é superior à dose vacinal."));
            ...
            ArrayList<String> corretas15 = new ArrayList<>();
            corretas15.add("Termo Científico");
            corretas15.add("Ausência de Soluções Mágicas");
            corretas15.add("Público-Alvo Bem Delimitado");
            corretas15.add("Estrutura Informativa");

            bancoManchetes.add(new QuestaoQuiz(true, "noticia 15.jpg", just15, corretas15, "A notícia sobre a Calixcoca é verdadeira. Como vacina terapêutica experimental desenvolvida pela UFMG, ela estimula a produção de anticorpos que se ligam à cocaína no sangue, impedindo a molécula de chegar ao cérebro e gerar efeitos psicoativos. O texto mantém o rigor científico ao destacar que a pesquisa está em fase pré-clínica (testes em laboratório e animais) e serve como ferramenta de apoio para evitar recaídas em pacientes já em abstinência, sem prometer curas milagrosas."));
            ...
            ArrayList<String> corretas16 = new ArrayList<>();
            corretas16.add("Termo Científico");
            corretas16.add("Ausência de Soluções Mágicas");

            bancoManchetes.add(new QuestaoQuiz(true, "noticia 16.jpg", just16, corretas16, "A notícia sobre a vacina experimental LungVax é verdadeira. O texto relata de forma factual o planejamento de um estudo clínico de Fase 1 no Reino Unido, coordenado pela University of Oxford e UCL, para avaliar a segurança e a dosagem de um imunizante voltado a prevenir o câncer de pulmão em grupos de alto risco. A veracidade é respaldada pela indicação correta do mecanismo biológico, treinar o sistema imune contra células anormais, pela menção a fundos e entidades de financiamento legítmas, como a Cancer Research UK, e pela ausência de promessas sensacionalistas de cura."));
            ...
            ArrayList<String> corretas20 = new ArrayList<>();
            corretas20.add("Saúde pública real");
            corretas20.add("Tom informativo e neutro");
